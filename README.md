...
## OS
   This Project doesn't Depend on any specific OS you can run it in on Windows, Mac or Linux if you have Java Installed.
...
2) Run the App.java 
  ...
  That's pretty much it and then you get the Program running you can add Data and put it into Excel Sheets. I will be Adding a bunch of stuff in this Project in the Future. This is just a beta version of the Program.
